...
rule VirTool_Win64_CobaltStrike_G{
	meta:
		description = "VirTool:Win64/CobaltStrike.G,SIGNATURE_TYPE_PEHSTR_EXT,04 00 04 00 05 00 00 "
	...
	strings :
		...
		$a_03_4 = {48 89 c2 83 e2 ?? 41 8a 14 14 32 54 05 ?? 88 14 03 48 ff c0 eb } //1
	condition:
