...
rule VirTool_Win32_DumpLsassProc_C{
	meta:
		description = "VirTool:Win32/DumpLsassProc.C,SIGNATURE_TYPE_CMDHSTR_EXT,06 00 05 00 07 00 00 "
	...
	strings :
		...
		$a_02_6 = {5c 00 63 00 6f 00 6d 00 73 00 76 00 63 00 73 00 2e 00 64 00 6c 00 6c 00 [0-ff] 32 00 34 00 [0-ff] 66 00 75 00 6c 00 6c 00 } //1
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*1+(#a_02_3  & 1)*1+(#a_00_4  & 1)*1+(#a_02_5  & 1)*1+(#a_02_6  & 1)*1) >=5
