...
rule HackTool_Win32_Meterpreter_A_dll{
	...
	strings :
		$a_03_0 = {8e 4e 0e ec [0-04] aa fc 0d 7c } //1
		$a_03_1 = {81 f9 5d 68 fa 3c [0-04] 8b } //1
		$a_01_2 = {81 f9 5b bc 4a 6a 0f 85 } //1
		$a_03_3 = {8b 46 ec 89 45 f4 85 c0 ?? ?? ?? ?? ?? 50 ?? ?? ?? ?? 50 ?? ?? ?? 50 ?? ?? ?? 6a ff 50 e8 ?? ?? ?? ?? 8b ?? f8 83 c4 18 83 c6 28 85 ff 0f 85 ?? ?? ?? ?? 8b 5d ec } //1
	condition:
...
rule HackTool_Win32_Meterpreter_A_dll_4{
	...
	strings :
		...
		$a_03_1 = {81 f9 5d 68 fa 3c 75 ?? 8b } //1
		$a_03_2 = {b8 0a 4c 53 75 21 8b 45 ?? 0f b7 } //1
		$a_03_3 = {8e 4e 0e ec 74 [0-03] aa fc 0d 7c 74 [0-03] 54 ca af 91 74 [0-03] 1b c6 46 79 74 [0-03] f2 32 f6 0e 75 } //1
...
rule HackTool_Win32_Meterpreter_A_dll_5{
	...
	strings :
		...
		$a_03_2 = {8e 4e 0e ec 74 [0-03] aa fc 0d 7c 74 [0-03] 54 ca af 91 74 [0-03] f2 32 f6 0e 75 } //1
		$a_03_3 = {81 f9 5d 68 fa 3c 75 ?? 8b } //1
		$a_03_4 = {b8 0a 4c 53 75 21 8b 45 ?? 0f b7 } //1
...
rule HackTool_Win32_Meterpreter_A_dll_6{
	...
	strings :
		...
		$a_03_1 = {73 61 6d 73 72 76 2e 64 6c 6c [0-20] 53 61 6d 49 43 6f 6e 6e 65 63 74 [0-20] 53 61 6d 72 4f 70 65 6e 44 6f 6d 61 69 6e } //1
		$a_03_2 = {47 6c 6f 62 61 6c 5c 53 41 4d [0-20] 47 6c 6f 62 61 6c 5c 46 52 45 45 } //1
		$a_03_3 = {50 6a 00 68 ff 00 0f 00 ff 15 ?? ?? ?? ?? 50 ff 15 ?? ?? ?? ?? 85 c0 ?? ?? 8d 45 dc 50 6a 02 ff 75 f4 ff 15 ?? ?? ?? ?? 85 c0 } //1
		$a_03_4 = {6a 40 68 00 10 00 00 ff 75 f0 6a 00 53 ff 15 ?? ?? ?? ?? 89 45 dc 85 c0 ?? ?? 8d 4d ?? 51 ff 75 f0 68 6a 2f 00 10 50 53 ff 15 ?? ?? ?? ?? 85 c0 } //1
		$a_03_5 = {6c 73 61 73 73 2e 65 78 65 [0-20] 53 65 44 65 62 75 67 50 72 69 76 69 6c 65 67 65 } //1
...
rule HackTool_Win32_Meterpreter_A_dll_7{
	...
	strings :
		...
		$a_03_1 = {73 61 6d 73 72 76 2e 64 6c 6c [0-20] 53 61 6d 49 43 6f 6e 6e 65 63 74 [0-20] 53 61 6d 72 4f 70 65 6e 44 6f 6d 61 69 6e } //1
		$a_03_2 = {47 6c 6f 62 61 6c 5c 53 41 4d [0-20] 47 6c 6f 62 61 6c 5c 46 52 45 45 } //1
		$a_03_3 = {45 33 c0 48 8b c8 ba ff 00 0f 00 ff 15 ?? ?? ?? ?? 85 c0 ?? ?? 48 8b 4c 24 48 4c 8d ?? ?? ?? ba 02 00 00 00 ff 15 ?? ?? ?? ?? 85 c0 } //1
		$a_03_4 = {45 8b fe c7 44 24 20 04 00 00 00 41 b9 00 30 00 00 45 8b c6 33 d2 48 8b cf ff 15 ?? ?? ?? ?? 4c 8b f0 48 85 c0 ?? ?? 48 89 5c 24 20 45 8b cf 4c 8b c6 48 8b d0 48 8b cf ff 15 } //1
		$a_03_5 = {6c 73 61 73 73 2e 65 78 65 [0-20] 53 65 44 65 62 75 67 50 72 69 76 69 6c 65 67 65 } //1
		$a_01_6 = {63 6d 64 2e 65 78 65 20 2f 63 20 65 63 68 6f 20 25 73 20 3e 20 25 73 } //1 cmd.exe /c echo %s > %s
	condition:
		((#a_81_0  & 1)*1+(#a_03_1  & 1)*1+(#a_03_2  & 1)*1+(#a_03_3  & 1)*1+(#a_03_4  & 1)*1+(#a_03_5  & 1)*1+(#a_01_6  & 1)*1) >=7
