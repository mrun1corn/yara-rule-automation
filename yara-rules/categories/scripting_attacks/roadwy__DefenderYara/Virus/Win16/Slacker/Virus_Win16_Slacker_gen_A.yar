...
rule Virus_Win16_Slacker_gen_A{
	...
	strings :
		...
		$a_03_3 = {78 6c 57 42 2e 53 61 76 65 41 73 20 ?? 69 6c 65 ?? 61 6d 65 3a 3d 41 70 70 6c 69 63 61 74 69 6f 6e 2e 53 74 61 72 74 75 70 50 61 74 68 20 2b 20 22 5c 42 6f 6f 6b 31 2e 22 2c 20 46 69 6c 65 46 6f 72 6d 61 74 3a 3d 78 6c 4e 6f 72 6d 61 6c 2c 20 41 64 64 54 6f 4d 72 75 3a 3d 46 61 6c 73 65 } //1
