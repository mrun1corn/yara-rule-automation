...
rule _PseudoThreat_c00008ac{
	meta:
		description = "!PseudoThreat_c00008ac,SIGNATURE_TYPE_PEHSTR_EXT,ffffff92 01 ffffff92 01 06 00 00 "
		
	strings :
		$a_00_0 = {53 4f 46 54 57 41 52 45 5c 42 6f 72 6c 61 6e 64 5c 44 65 6c 70 68 69 5c 52 54 4c } //100 SOFTWARE\Borland\Delphi\RTL
		$a_02_1 = {6d 70 5f 66 69 6c 65 64 6f 77 6e [0-04] 2e 70 68 70 3f 73 6e 3d } //100
		$a_02_2 = {6d 70 5f 63 6e 74 73 [0-04] 2e 70 68 70 3f 73 6e 3d } //100
		$a_02_3 = {63 3a 5c 6d 70 72 [0-05] 2e 69 6e 69 } //100
