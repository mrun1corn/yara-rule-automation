...
rule HackTool_Win32_Nsudo_B{
	meta:
		description = "HackTool:Win32/Nsudo.B,SIGNATURE_TYPE_CMDHSTR_EXT,03 00 03 00 06 00 00 "
	...
	strings :
		...
		$a_00_5 = {73 00 61 00 70 00 6c 00 6f 00 67 00 6f 00 6e 00 2e 00 65 00 78 00 65 00 } //-1000 saplogon.exe
	condition:
		((#a_00_0  & 1)*1+(#a_00_1  & 1)*1+(#a_00_2  & 1)*2+(#a_00_3  & 1)*-1000+(#a_00_4  & 1)*-1000+(#a_00_5  & 1)*-1000) >=3
